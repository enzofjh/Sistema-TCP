...
namespace Servidor
{
    public partial class ServidorForm : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'uNED_DataSet.Usuarios' table. You can move, or remove it, as needed.
            this.usuariosTableAdapter.Fill(this.uNED_DataSet.Usuarios);
        ...
        public void EscribirMensaje(ConexionTcp conexionTcp, string message)
        {
            try
            {
                conexionTcp.StreamWriter.Write(message);
                conexionTcp.StreamWriter.Flush();
            }
            catch (Exception e)
            {
                MessageBox.Show(e.Message.ToString());
        ...
        private void usuariosBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this.uNED_DataSet);
        }
        ...
        //public static void Write(this Paquete paquete, ConexionTcp conexionTcp)
        //{
        //    EscribirMensaje(conexionTcp, paquete.Serializar());
        //}
    }
}
