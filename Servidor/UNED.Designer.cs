...
namespace Servidor {
    ...
    public partial class UNED : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nombre, string Contrasena) {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuarios] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND " +
                "[Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Contrasena = 1" +
                " AND [Contrasena] IS NULL) OR ([Contrasena] = @Original_Contrasena)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO Usuarios\r\n                         (Nombre, Contrasena)\r\nVALUES      " +
                "  (@Nombre,@Contrasena); \r\nSELECT Id, Nombre, Contrasena FROM Usuarios WHERE (Id" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuarios] SET [Nombre] = @Nombre, [Contrasena] = @Contrasena WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Contrasena = 1 AND [Contrasena] IS NULL) OR ([Contrasena] = @Original_Contrasena)));
SELECT Id, Nombre, Contrasena FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, Nombre, Contrasena\r\nFROM            Usuarios";
